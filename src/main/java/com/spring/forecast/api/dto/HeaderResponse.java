...
public class HeaderResponse {
	...
	public HeaderResponse(String header1, String header2, String header3, String header4, String header5,
			String header6, String header7, String header8, String header9, String header10, String header11,
			String header12, String header13, String header14, String header15, String header16, String header17,
			String header18, String image) {
		super();
		this.header1 = header1;
		this.header2 = header2;
		this.header3 = header3;
